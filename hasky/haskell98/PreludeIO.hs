...
foreign import ccall unsafe getContents      :: IO String
foreign import ccall unsafe readFile         :: FilePath -> IO String
foreign import ccall unsafe writeFile        :: FilePath -> String -> IO ()
foreign import ccall unsafe appendFile       :: FilePath -> String -> IO ()
