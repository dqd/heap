...
-- unparseable -- data  ()  =  ()  deriving (Eq, Ord, Enum, Bounded, Ix)

-- Function type

--data a -> b  -- No constructor for functions is exported.
-- unparseable -- data (->) a b
...
-- unparseable -- data Char -- = ... 'a' | 'b' ... -- 2^16 unicode values
...
-- unparseable -- data  IO a -- abstract
...
-- unparseable -- data  Int  -- =  minBound ... -1 | 0 | 1 ... maxBound
...
-- unparseable -- data  Integer  -- =  ... -1 | 0 | 1 ...
...
-- unparseable -- data [a] =  [] | a : [a]  deriving (Eq, Ord)
--instance Eq a => Eq [a]
