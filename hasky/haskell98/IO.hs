...
-- unparseable -- data PrimHandle
instance Eq PrimHandle
instance Show PrimHandle

foreign import ccall unsafe prim_stdin :: PrimHandle
foreign import ccall unsafe prim_stdout :: PrimHandle
foreign import ccall unsafe prim_stderr :: PrimHandle
foreign import ccall unsafe primHPutChar :: PrimHandle -> Char -> IO ()
foreign import ccall unsafe primHPutStr :: PrimHandle -> String -> IO ()
foreign import ccall unsafe primHFlush :: PrimHandle -> IO ()
...
foreign import ccall unsafe openFile :: FilePath -> IOMode -> IO Handle
foreign import ccall unsafe hClose :: Handle -> IO ()
foreign import ccall unsafe hGetLine :: Handle -> IO String
foreign import ccall unsafe hGetContents :: Handle -> IO String
